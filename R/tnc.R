#' Calculate the true negative count of a vector of predicted probabilities against a binary outcome at a given threshold.
#' @export
#'
...
#' @return The true negative count is the number of observations predicted as negative that are indeed negative
#' @examples
